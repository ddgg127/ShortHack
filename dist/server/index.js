...
- missing: конкретно перечисли сведения, которых не хватает. Если всё есть, напиши "Дополнительные сведения не требуются.";
- nextAction: одно конкретное действие оператора после получения обращения;
...
const normalizeResult = (raw, description, source) => ({
  ...
  missing: cleanText(raw.missing, 'Дополнительные сведения не требуются.', 600),
  nextAction: cleanText(raw.nextAction, 'Передать обращение оператору первой линии.', 600),
